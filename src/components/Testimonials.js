export default function Testimonials() {
  ...
  return (
    <section className="py-24 bg-white dark:bg-black text-background dark:text-foreground">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg border border-gray-200 dark:border-gray-700 text-background dark:text-foreground">
              <div className="flex flex-col h-full">
                ...
                <h3 className="text-xl font-bold mb-4 text-background dark:text-foreground">{testimonial.quote}</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-6 flex-grow">{testimonial.content}</p>
                <div className="mt-auto pt-4 border-t border-gray-200 dark:border-gray-700">
                  <p className="font-medium text-background dark:text-foreground">{testimonial.author}</p>
